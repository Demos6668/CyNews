              ...
              <div className="p-4 flex items-center justify-between">
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <Badge className={getSeverityBadgeColors(result.severity)}>{result.severity?.toUpperCase() ?? 'INFO'}</Badge>
                  ...
                  <p className="text-sm text-muted-foreground line-clamp-1">{stripHtml(result.summary ?? "")}</p>
                </div>
