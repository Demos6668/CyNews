...
<p style="color:#9CA3AF;font-size:11px;margin:0;font-family:Arial,sans-serif;">Prepared by CYFY Security Operations Center</p></div>
</div></body></html>`;
  }
