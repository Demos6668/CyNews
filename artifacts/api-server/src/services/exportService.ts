...
<head>
  ...
  <title>${cveId} - Security Advisory | Security Operations Team</title>
  <style>
...
<body>
  <div class="header">
    <div class="logo">Security Operations Team - Advisory</div>
  ...
  <div class="footer">
    <p>This advisory was generated by Security Operations Team</p>
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>${escapeHtml(title)} | Security Operations Team</title>
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
...
<body>
  <div class="header">
    <div class="logo">Security Operations Team - Advisories Report</div>
  ...
  <div class="footer">
    <p>This report was generated by Security Operations Team - For internal use only - ${new Date().getFullYear()}</p>
  </div>
</body>
</html>`;
}
